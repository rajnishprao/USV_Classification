...
for img in os.listdir('./proestrous'):
    ...
    if f_ext == '.png':
        ...
        shutil.copy('./proestrous/' + f_name + f_ext,
                    location + '/pr/' + f_name + f_ext)
...
for img in os.listdir('./estrous'):
    ...
    if f_ext == '.png':
        ...
        shutil.copy('./estrous/' + f_name + f_ext,
                    location + '/es/' + f_name + f_ext)
...
for img in os.listdir('./metestrous'):
    ...
    if f_ext == '.png':
        ...
        shutil.copy('./metestrous/' + f_name + f_ext,
                    location + '/me/' + f_name + f_ext)
...
for img in os.listdir('./diestrous'):
    ...
    if f_ext == '.png':
        ...
        shutil.copy('./diestrous/' + f_name + f_ext,
                    location + '/di/' + f_name + f_ext)
