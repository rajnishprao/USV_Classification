...
# elu almost as good as relu
# selu defiantely worse
# tanh also not very great
...
plt.xlabel('Epochs')
plt.legend()
plt.savefig('./figs_cnn_deepsqueak/loss_two_classes.jpg', dpi=300)
plt.show()
...
plt.ylim(0, 1)
plt.legend()
plt.savefig('./figs_cnn_deepsqueak/accuracy_two_classes.jpg', dpi=300)
plt.show()
...
plt.savefig('./figs_cnn_deepsqueak/cnn_confusion_matrix.jpg', dpi=300)
plt.show()
