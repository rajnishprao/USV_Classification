...
multi class categorization depending on estrous state of caller
"""
...
# not using class_weight gives better loss curves
...
print(cm)
index = ["diestrous", "estrous", "metestrous", "proestrous"]
columns = ["diestrous", "estrous", "metestrous", "proestrous"]
